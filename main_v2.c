...
int main() {
    ...
    // 示例1：N=1000, D=1e4 → 重复1000次
    test_large_scale_repeat(1000, 1000, 10000, "N=1000, D=1e4 (Repeat 1000 Times)");
    // 示例2：N=10000, D=1e5 → 重复1000次（平衡时间和统计意义）
    test_large_scale_repeat(1000, 10000, 100000, "N=10000, D=1e5 (Repeat 1000 Times)");
    // 示例3：N=100000, D=1e6 → 重复1000次
    test_large_scale_repeat(1000, 100000, 1000000, "N=1e5, D=1e6 (Repeat 1000 Times)");
    // 示例4：N=100000, D=1e6 → 重复10000次
    test_large_scale_repeat(10000, 100000, 1000000, "N=1e5, D=1e6 (Repeat 10000 Times)");
    //
    return 0;
}
